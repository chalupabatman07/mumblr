...
import { DiscoveryResolver, LifestyleResolver, MatchResolver, ProfileResolver, UserResolver } from '../../graphql';
import { LOGIN, SIGN_UP, UPDATE_PASSWORD } from '../routes';

const createSchema = (): Promise<GraphQLSchema> =>
  buildSchema({
    resolvers: [DiscoveryResolver, LifestyleResolver, MatchResolver, ProfileResolver, UserResolver],
